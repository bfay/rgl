...
<head id="www.eighthloop.com" data-template-set="Fibonacci">
	...
	<title>Rockin Guitar Lessons</title>
	...
	<meta name="keywords" content="Fibonacci Sequence web design, rapid prototyping framework wordpress, fibonacci spiral, fibonacci retracement web design, golden ratio web design, golden spiral web design,  wordpress framework, css framework, html framework, html5, css3 transitions, css3, LESS, .less, Codekit compiler, responsive design, hybrid responsive web design, RWD, HRWD, modernizr, categorizr, selectivizr, how to build a website, CodeKit, Coda 2, web developer, barberton ohio, north canton ohio, akron ohio, cleveland ohio, northeast ohio, web design barberton ohio, web design norton ohio, web design canton ohio, web design wadsworth ohio, web design north canton ohio, front-end development, front end devlopment, web front end development">
